...
const (
	RaftService_RequestVote_FullMethodName   = "/kafkaflow.RaftService/RequestVote"
	RaftService_AppendEntries_FullMethodName = "/kafkaflow.RaftService/AppendEntries"
)
...
var RaftService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kafkaflow.RaftService",
